...
public class TaskFillArea extends TaskProcessChunkBase
{
    ...
    public TaskFillArea(List<Box> boxes, BlockState fillState,  BlockState replaceState, boolean removeEntities)
    {
        this(boxes, fillState, replaceState, removeEntities, "litematica.gui.label.task_name.fill");
    }

    protected TaskFillArea(List<Box> boxes, BlockState fillState,  BlockState replaceState, boolean removeEntities, String nameOnHud)
    {
        super(nameOnHud);
